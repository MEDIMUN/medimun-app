...
export function LearnMoreButton(props) {
	return (
		<Link href={props.href}>
			<button className="mb-3 w-[210px] cursor-pointer rounded-[100px] from-80% pl-[20px] font-['canela'] text-[15px] leading-[45px] text-gray-400 duration-200 [text-shadow:_2px_2px_#000000] hover:ml-[20px] hover:bg-white hover:text-[var(--medired)] hover:shadow-lg hover:[text-shadow:_none] md:text-[25px]">
				{props.children}
			</button>
		</Link>
	);
			...
			<div className="rounded-[5px] bg-white">
				...
				<Section1>
					<div className="bottom-0 mb-[46vh] mt-auto w-full text-left ">
						<h2 className="mb-3 select-none bg-gradient-to-t from-[var(--medired)] from-80% to-80% pl-[20px] font-['montserrat'] text-[52px] leading-[55px] text-white [text-shadow:_4px_4px_#000000] md:text-[100px] md:leading-[110px]">
							{theme}
						</h2>
						<h2 className="ml-[20px] select-none stroke-white font-['Canela'] text-[35px] leading-[35px] text-[var(--medired)] [-webkit-text-stroke-color:_rgb(255,255,255);] [-webkit-text-stroke-width:_1px;] md:text-[50px] md:leading-[70px]">
							{phrase2}
						</h2>
					</div>
				</Section1>
				...
				<div id="totalH">
					<section className={outerStyle + "bg-gradient-to-t from-[var(--medired)]"}>
						<div className={sectionStyle}>
							<div className="mx-auto max-w-[1400px]">
								...
								<p className="mb-3 from-80% pl-[20px] font-['Canela'] text-[15px] leading-[20px] text-white [text-shadow:_2px_2px_#000000] md:text-[30px]  md:leading-[40px]">
									{welcomeText}
								</p>
					...
					<section className={outerStyle + "bg-[var(--medired)]"}>
						<div className={sectionStyle}>
							<div className="mx-auto max-w-[1400px]">
								<h3 className="mb-4 from-80% pl-[20px] font-['Canela'] text-[30px] leading-[40px] text-transparent [-webkit-text-stroke-color:_rgb(255,255,255);] [-webkit-text-stroke-width:_1px;] md:text-[50px] md:leading-[55px]">
				...
				<section className="relative z-[6] grid min-h-[100svh] w-[100%] translate-y-12 select-none bg-[var(--medired)] p-10 text-center font-['canela'] text-white shadow-2xl sm:gap-3 md:grid-cols-2 lg:grid-cols-3 lg:gap-0">
					<div className="m-auto max-h-full w-full max-w-[400px] !overflow-hidden rounded-lg">
						<Image
							alt="Image of The English School in Cyprus and the surrounding forest"
							className="globallogo min-h-full w-full overflow-hidden rounded-lg object-cover object-bottom shadow-xl duration-150 hover:scale-150"
							quality={50}
							src={es2}
						/>
					</div>
					...
					<div className="m-auto max-h-full max-w-[400px] !overflow-hidden rounded-lg">
						<Image
							alt="Image of The English School taken from the front"
							className="globallogo !max-h-auto w-full overflow-hidden rounded-lg object-cover object-bottom duration-150 hover:scale-150"
							quality={50}
							src={es1}
						/>
					</div>
					...
					<div className="m-auto max-h-full max-w-[400px] !overflow-hidden rounded-lg">
						<Image
							alt="500 delegates standing up at the end of a plenary session"
							className="globallogo !max-h-auto w-full overflow-hidden rounded-lg object-cover object-bottom duration-150 hover:scale-150"
							quality={50}
							src={delegates3}
						/>
					...
					<div className="m-auto max-h-full max-w-[400px] !overflow-hidden rounded-lg">
						<Image
							alt="Delegates and the organising body of the conference taking a picture outside"
							className="globallogo !max-h-auto w-full overflow-hidden rounded-lg object-cover object-bottom duration-150 hover:scale-150"
							quality={50}
							src={delegates2}
						/>
					...
					<div className="m-auto max-h-full max-w-[400px] !overflow-hidden rounded-lg sm:block md:hidden lg:block">
						<Image
							alt="An image of Cyprus's capital Nicosia taken from above"
							className="globallogo !max-h-auto w-full overflow-hidden rounded-lg object-cover object-bottom duration-150 hover:scale-150"
							quality={50}
							src={nicosia1}
						/>
