...
export default async function Page() {
	...
	return (
		<div className="h-screen">
			<Background />
			<div className="mx-auto h-full w-full max-w-[1248px] p-6 pt-24">
				<h1 className="rounded-3xl font-[Montserrat] text-[35px] font-[700] text-white">Sessions</h1>
				<h2 className="mb-6 rounded-3xl font-[Montserrat] text-[20px] font-[300] text-white">Explore the latest announcements from organizers</h2>
				<SearchBar />
