					...
					return (
						<li key={department.id}>
							<Link href={`/medibook/sessions/${params.sessionNumber}/departments/${department.slug || department.id}`}>
								<Card className={`h-[212px] overflow-hidden border-0 bg-cover bg-center text-white shadow-2xl shadow-slate-900 duration-300 md:hover:shadow-md`} style={{ backgroundImage: `url(${departmentTypes[department.type] || "/pages/index/section3images/6.jpeg"})` }}>
