...
export default async function Page(props) {
  ...
  return (
    <>
      ...
      />
      {!!sessions.length && (
        <ul className="mx-auto max-w-7xl px-5 font-[montserrat]">
            ...
            return (
              <Fragment key={session.id}>
                <li
                  className={cn(
                    "bg-cover",
                    session?.isMainShown && "mb-6 overflow-hidden rounded-lg text-zinc-800 shadow-md duration-300",
                  )}
                  style={
                    session.isMainShown
                      ? session.cover
...
const researchBooklets = [
  {
    ...
    href: "https://drive.google.com/file/d/1uye5uwpkvhsBtJV7bIN4zDnKDjgLHUG2/view?usp=sharing",
  },
  {
    name: "General Assembly 2",
    href: "https://drive.google.com/file/d/1Z5OvpZd3elmJ_c6v1tk8WCuO9RjWPN_Z/view?usp=sharing",
  },
  {
    name: "General Assembly 3",
    href: "https://drive.google.com/file/d/16_SYkqQeRVIBbWUnYnWvCW3kPN7gBeEb/view?usp=sharing",
  },
  {
    name: "General Assembly 4",
    href: "https://drive.google.com/file/d/1UOVvLd80sLPkHkvAF1ShUgWz2UqfOe47/view?usp=sharing",
  },
  {
    name: "Security Council",
    href: "https://drive.google.com/file/d/1FBAv5s9VfFcTzERZiumOax8gldxLkCT_/view?usp=sharing",
  },
  {
    name: "Historical Security Council",
    href: "https://drive.google.com/file/d/1x9GADBXTiMFeBCAukIzo-700SMsBznDS/view?usp=sharing",
  },
  {
    name: "Commission on the Status of Women",
    href: "https://drive.google.com/file/d/1YNRKOvia9_r0LzLdIRH5LDAdxkDGzrQe/view?usp=sharing",
  },
];
