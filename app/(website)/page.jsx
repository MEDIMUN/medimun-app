			...
			<div className="rounded-[5px] bg-white">
				...
				<Section1>
					<div className="bottom-0 mb-[46vh] mt-auto w-full text-left ">
						<h2 className="mb-3 select-none bg-gradient-to-t from-[var(--medired)] from-80% to-80% pl-[20px] font-['Canela'] text-[52px] leading-[55px] text-white [text-shadow:_4px_4px_#000000] md:text-[100px] md:leading-[110px]">
							{theme}
						</h2>
