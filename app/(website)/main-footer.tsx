...
const navigation = {
  ...
  company: [
    ...
    { name: "Account Help", href: "/login/help" },
  ],
  legal: [
  ...
  social: [
    ...
    {
      name: "Instagram",
      href: "https://instagram.com/medimun.cy",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "GitHub",
      href: "https://www.github.com/medimun",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/@medimun-cy",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export async function Footer() {
  ...
  return (
    <footer className="z-200 absolute w-full bg-black font-[montserrat] font-thin" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6 text-white">MediBook</h3>
                <ul role="list" className="mt-6 space-y-4">
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-zinc-400">
            &copy; 2005 - {currentYear} Mediterranean Model United Nations. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
