...
const benefits = ["6 - 8 Feb 2026", "7 Committees", "500 Delegates", "100s of Volunteers"];
...
export async function HomePage() {
  ...
  return (
    <>
      <div className="relative isolate h-svh bg-black pt-14 font-[Gilroy]">
        <div
          aria-hidden="true"
        ...
        >
          <div
            ...
            className="aspect-1155/678 w-144.5 rotate-30 bg-linear-to-tr sm:w-288.75 relative left-[calc(50%-11rem)] -translate-x-1/2 from-[#ff80b5] to-[#9089fc] opacity-20 sm:left-[calc(50%-30rem)]"
          />
        </div>
        {/* <svg
        ...
        <div className="absolute mx-auto mt-[20svh] flex w-full flex-col md:mt-[35vh]">
          <div className="mx-auto flex max-w-5xl flex-col gap-1 px-4 text-left text-white md:gap-2 md:text-center">
            {currentSession?.theme && (
              <h1 className="leading-[50px]! font-[canela] text-5xl md:text-6xl">{currentSession.theme}</h1>
            )}
            {currentSession?.subTheme && (
              <h2 className="font-[LondiniaMedium] text-4xl text-zinc-300">{currentSession.subTheme}</h2>
            )}
          </div>
        </div>
      </div>
      <div className="bg-black pb-10 font-[GilroyLight] text-white">
        <div className="relative pt-32 sm:pt-40">
            ...
            <div className="mx-auto flex max-w-2xl flex-col gap-16 bg-white/70 px-6 py-16 ring-1 ring-black/10 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
              {currentSession?.cover ? (
                ...
                <div
                  ...
                  className="!relative flex h-96 w-full flex-none rounded-2xl bg-opacity-35 bg-cover object-cover shadow-xl lg:aspect-square lg:h-auto lg:max-w-sm"
                >
                  <p className="-font-[canela] font-black! my-auto w-full translate-y-[15px] bg-[url(/assets/gradients/1.jpg)] bg-cover bg-clip-text text-center text-[12rem] text-transparent">
              ...
              <div className="w-full flex-auto">
                ...
                {currentSession.welcomeText && (
                  <p className="mt-6 text-lg leading-8 text-gray-700">{currentSession.welcomeText}</p>
                )}
                <ul
                  role="list"
                ...
                <div className="mt-10 flex">
                  <Link href="/sessions/20" className="text-primary text-sm font-semibold leading-6">
          ...
          >
            <div
              ...
              className="aspect-1318/752 w-329.5 bg-linear-to-r from-primary flex-none to-[#4f46e5] opacity-25"
            />
          </div>
        </div>
      </div>
      <div className="overflow-hidden bg-black pt-32 font-[GilroyLight] sm:pt-40">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
            <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
              ...
              <p className="mt-6 text-xl leading-8 text-gray-200">
                Mediterranean Model United Nations, the largest and oldest THIMUN-affiliated MUN conference in the
                Mediterranean region, is a simulation of the United Nations for high school students.{" "}
              </p>
      ...
      <div className="overflow-hidden bg-black py-24 font-[GilroyLight] sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg">
                <h2 className="text-base font-semibold leading-7 text-gray-100">Introdoucing</h2>
                <p className="text-primary mt-2 font-[canela] text-3xl sm:text-4xl">MediBook</p>
            ...
            <Image
              ...
              height={1442}
              quality={60}
              className="w-3xl sm:w-228 max-w-none rounded-2xl shadow-xl ring-1 ring-gray-400/10 md:-ml-4 lg:-ml-0"
            />
          </div>
        </div>
      </div>
