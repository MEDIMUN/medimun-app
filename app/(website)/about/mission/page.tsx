  ...
  return (
    <div className="dark w-full">
      <Topbar
        ...
        description={"Explaining our mission of building a better future for everyone."}
      />
      <div className="z-100 relative isolate bg-black">
        <div
          aria-hidden="true"
          ...
          <div className="mx-auto max-w-7xl px-6 pb-32 lg:px-8">
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                <TextGenerateEffect words={words} className="font-thin! mx-auto max-w-7xl font-[Gilroy]" />
              </div>
              <div className="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
                <div className="xl:order-0 ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:pt-80">
