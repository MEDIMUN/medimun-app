			...
			<main className="isolate">
				...
				<div className="relative isolate -z-10">
					...
					<div className="overflow-hidden">
						<div className="mx-auto max-w-7xl px-6 pb-32 pt-32 sm:pt-60 lg:px-8 lg:pt-36">
								...
								<div className="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
									<div className="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80">
										<div className="relative">
											<Image
												src="/pages/index/dabbing.jpg"
												alt=""
												width={600}
												height={600}
												quality={90}
												className="!relative aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover object-left shadow-lg duration-300 hover:scale-110"
											/>
									...
									<div className="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
										<div className="relative">
											<Image
												...
												alt=""
												className="!relative aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover object-center shadow-lg duration-300 hover:scale-110"
											/>
											<div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
										</div>
										<div className="relative">
											<Image
												...
												height={600}
												quality={90}
												className="!relative aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg duration-300 hover:scale-110"
											/>
											<div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
										</div>
									</div>
				...
				<div className="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
					<div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
						<p className="mb-2 max-w-max bg-zinc-950/5 px-2 text-xs uppercase tracking-wider ">The 2024 Conference</p>
						<h2 className="text-3xl font-bold  tracking-tight text-gray-900 sm:text-4xl">
							20<sup>th</sup> Annual Session
						</h2>
				...
				<div className="mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8">
					<img src="/pages/index/dabbing.jpg" alt="" className="aspect-[5/2] w-full object-cover xl:rounded-3xl" />
				</div>
				...
				<div className="relative isolate -z-10 mt-32 sm:mt-48">
					...
					<div className="mx-auto max-w-7xl px-6 lg:px-8">
						...
						<div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
							...
							/>
							<img
								className="col-span-2 max-h-12 w-full bg-red-500 object-contain lg:col-span-1"
