...
const CanvasRevealEffectThree = dynamic(() => import("./_components/canvas-reveal-three").then((mod) => mod.CanvasRevealEffectThree));
...
export default async function AboutPage() {
	...
	return (
		<>
			...
			<div className="pb-32 overflow-hidden sm:mt-40 font-[Gilroy] text-white">
				<div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
					<div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
						<div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
							<p className="mt-6 text-xl/8 text-gray-100">
								Mediterranean Model United Nations holds the distinction of being the largest and oldest Model United Nations conference in Cyprus. It
								is organized and operated on a non-profit basis by student and teacher volunteers who dedicate their time and efforts to its success.
							</p>
						</div>
