        ...
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto mt-10 max-w-xl lg:mx-0 lg:mt-0 lg:max-w-lg">
            <div className="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden bg-gray-800 ring-1 ring-gray-900/10 lg:w-1/2">
              <svg
                className="mask-[radial-gradient(100%_100%_at_top_right,white,transparent)] absolute inset-0 h-full w-full stroke-gray-800"
                aria-hidden="true"
              >
                <defs>
                  <pattern
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              We welcome your inquiries and feedback. Please do not hesitate to contact us with any questions or
            ...
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-200">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="hover:text-gray-900" href="info@medimun.org">
                    info@medimun.org
                  </a>
                </dd>
              </div>
