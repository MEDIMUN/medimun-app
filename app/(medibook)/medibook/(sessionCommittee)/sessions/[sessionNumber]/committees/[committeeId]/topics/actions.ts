...
export async function editTopics(formData) {
	...
	if ((committee.topic1 && typeof committee.topic1 !== "string") || (committee.topic2 && typeof committee.topic2 !== "string") || (committee.topic3 && typeof committee.topic3 !== "string"))
		return { ok: false, error: "Invalid input", title: "Invalid input", description: "Please fill in all fields", variant: "destructive" };
	if ((committee.topic1description && typeof committee.topic1description !== "string") || (committee.topic2description && typeof committee.topic2description !== "string") || (committee.topic3description && typeof committee.topic3description !== "string"))
		return { ok: false, error: "Invalid input", title: "Invalid input", description: "Please fill in all fields", variant: "destructive" };
