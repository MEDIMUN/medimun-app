...
export default async function Modals(props) {
	...
	return (
		<>
			<AddExtraCountryModal />
			{selectedCommittee && selectedExtraCountry && (
				<EditExtraCountryModal selectedCommittee={selectedCommittee} selectedExtraCountry={selectedExtraCountry} />
			)}
		</>
	);
}
