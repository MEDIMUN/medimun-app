...
async function UsersContent({ props }) {
      ...
      <MainWrapper>
        <SelectedContextProvider defaultUserData={editUsers}>
          ...
          <div className="relative">
                ...
                {processedUsers.map((user) => {
                  return (
                    <TableRow key={user.id}>
                      ...
                      <TableCell className="invisible min-w-0 md:visible md:min-w-20"></TableCell>
                      ...
                      <TableCell>
                        {!!user?.currentRoleNames.length ? <DisplayCurrentRoles user={user} /> : "-"}
                      </TableCell>
            ...
            <Table className="showscrollbar z-8 border-r-1 absolute top-0 bg-white dark:bg-zinc-900">
              <TableHead>
                <TableRow>
                  <TableHeader className="select-none text-white dark:text-black">S</TableHeader>
                  <TableHeader>
                    ...
                    <TableCell>
                      <Dropdown>
                        ...
                        <DropdownMenu>
                          ...
                          <SearchParamsDropDropdownItem searchParams={{ "assign-roles": user.id }}>
                            Add roles
                          </SearchParamsDropDropdownItem>
                          <SearchParamsDropDropdownItem searchParams={{ "edit-roles": user.id }}>
                            Edit roles
                          </SearchParamsDropDropdownItem>
                          <SearchParamsDropDropdownItem searchParams={{ "delete-user": user.id }}>
                            Delete user
                          </SearchParamsDropDropdownItem>
                        </DropdownMenu>
                      </Dropdown>
        ...
        fallback={
          <>
            <TopBar
              ...
              subheading={
                <>
                  <div className="h-4 w-32 animate-pulse rounded-md bg-gray-300"></div> Users
                </>
              }
              title="All Users"
              defaultSort="officialNameasc"
            ...
            <LoadingTable
              columns={["Name", "Surname", "Display Name", "Username", "Email", "ID", "School", "Account Type"]}
            />
          </>
        }
      >
        <UsersContent props={props} />
      </Suspense>
    </>
  );
}
