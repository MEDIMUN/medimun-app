...
export default async function SchoolDirectorApplicationsPage(props: {
  ...
  const [selectedSession, selectedUserHasApplication, userIsSchoolDirectorInSession, schools, selectedUser] =
    await Promise.all([
          ...
          {!selectedUser.bestTimeToReach && !selectedUserHasApplication && (
            <div className="rounded-md bg-zinc-100 p-4">
              <div className="flex">
                ...
                <Text className="ml-3">
                  You must add the <Strong>Best Time To Reach You</Strong> option to your account to apply as a school
                  director. Check out the <TextLink href={"/medibook/account"}>Account Settings</TextLink> section.
                </Text>
              </div>
            </div>
          )}
            ...
            <>
              ...
              <div className="mt-4 rounded-md bg-zinc-100 px-4">
                <DescriptionList>
                  ...
                  <DescriptionDetails>
                    {selectedUserHasApplication.isApproved ? (
                  ...
                  <DescriptionDetails>
                    {selectedUserHasApplication.date.toLocaleString("en-GB").replace(",", " at ")}
                  </DescriptionDetails>
            ...
            <div className="rounded-md bg-zinc-100 p-4">
              <div className="flex flex-col">
                ...
                <ul className="ml-4 list-disc">
                  <Text as="li">
                    Each School Director must complete a separate application even if you represent the same school.
                  </Text>
                  <Text as="li">We may contact your school to verify your affiliation.</Text>
                  <Text as="li">
                    The application fee for this session is <Code>{selectedSession.directorPrice}€</Code> per school
                    director and <Code>{selectedSession.delegatePrice}€</Code> per delegate.
                  </Text>
                  <Text as="li">
                    If your school is not listed please reach out to us at{" "}
                    <TextLink href="mailto:info@medimun.org">info@medimun.org</TextLink> to have your school added to
                    the system.
                  </Text>
                  <Text as="li">
                    You can check the status of your application here, you will also receive an email once your
