...
export default async function Page({ params, searchParams }) {
	...
	const hasSomeArray: ResourcePrivacyTypes[] = [
		"COMMITTEEWEBSITE",
		authorizeChairCommittee([...authSession.currentRoles, ...authSession.pastRoles], selectedCommittee.id) ? "COMMITTEECHAIR" : null,
		authorizeDelegateCommittee([...authSession.currentRoles, ...authSession.pastRoles], selectedCommittee.id) ? "COMMITTEEDELEGATE" : null,
