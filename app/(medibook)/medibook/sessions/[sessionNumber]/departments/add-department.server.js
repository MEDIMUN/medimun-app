...
export async function addDepartment ( formData ) {
   ...
   if ( !sessionNumber || !name || !description || !departmentType ) return { ok: false, error: "Invalid input", title: "Invalid input", description: "Please fill in all required inputs", variant: "destructive" };
   if ( description.length > 100 || description.length < 10 ) return { ok: false, error: "Invalid input", title: "Invalid input", description: "Description must be between 10 and 100 characters", variant: "destructive" };
