...
export default function Drawer() {
	...
	return (
		<Modal isOpen={searchParams.has("add") && status === "authenticated" && authorize(session, [s.admins, s.sd])} onOpenChange={() => removeSearchParams({ add: "" }, router)}>
			<ModalContent>
				...
				<ModalFooter>
					<Button color="danger" variant="light" onPress={() => removeSearchParams({ add: "" }, router)} form="main" type="submit">
						Cancel
					</Button>
