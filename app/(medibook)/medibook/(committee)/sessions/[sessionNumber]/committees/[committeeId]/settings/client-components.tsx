    ...
    <form action={editCommitteeHandler} id="committee-settings" className="mx-auto">
      ...
      <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
        <div className="space-y-1">
          ...
          <Text>
            The type of the committee, this setting changes committee procedures and available countries and
            scjouldn&apos;t be changed mid-session.
          </Text>
        </div>
      ...
      <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
        ...
        <div className="flex">
          <Select
            className="my-auto"
            defaultValue={selectedCommittee?.isVisible ? "true" : "false"}
            required
            name="isVisible"
          >
      ...
      <section className="grid grid-cols-1 gap-x-8 gap-y-6">
        <div className="flex flex-col gap-4 md:flex-row">
          <div>
            ...
            <Text>
              Extra countries that can be assigned to delegates within the committee. e.g. &quot;European Union{" "}
              <em>(EU)</em>&quot;, &quot;Soviet Union <em>(USSR)</em>, &quot;World Health Organization <em>(WHO)</em>
              &quot;.
              <br />
              <em>Max 20</em>
            </Text>
