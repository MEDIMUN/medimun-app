...
export async function Delegates(props: {
  searchParams: any;
  params: Promise<{ sessionNumber: string; committeeId: string; page: string }>;
}) {
  await connection();
    ...
    <>
      ...
      <MainWrapper>
          ...
          <Table>
            ...
            <TableBody>
              {delegates.map((delegate) => {
                ...
                const isChairOfDelegate = authorizeChairCommittee(
                  ...
                  <TableRow key={delegate.id}>
                    <TableCell>
                      <Dropdown>
                        ...
                        <DropdownMenu>
                          {canAssignCountry && (
                            <SearchParamsDropDropdownItem searchParams={{ "edit-delegate-assignment": delegate.id }}>
                              Edit Assignment
                            </SearchParamsDropDropdownItem>
                          )}
                          <DropdownItem href={`/medibook/users/${user.username || user.id}`}>View Profile</DropdownItem>
                          <DropdownItem href={`/medibook/users/${user.username || user.id}?new=true`}>
                            Message
                          </DropdownItem>
                    ...
                    {(isChairOfCommittee || isManagement) && (
                      <TableCell>{<UserIdDisplay userId={user.id} />}</TableCell>
                    )}
                  </TableRow>
                );
              })}
        ...
        <Paginator
          ...
          itemsOnPage={selectedCommittee.delegate.length}
        />
      </MainWrapper>
    </>
  );
