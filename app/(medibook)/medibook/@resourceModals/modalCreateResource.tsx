							...
							{!file && !url && (
								<>
									<Field>
										...
										<Description>Max 50MB. Documents and images only, use the drive upload for other file types.</Description>
										<Button type="button" className="mt-2 w-full" onClick={() => inputRef.current.click()}>
											Select a File
										</Button>
									</Field>
									<div className="flex">
