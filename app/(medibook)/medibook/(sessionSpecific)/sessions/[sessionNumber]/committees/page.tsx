...
import { Dropdown, DropdownButton, DropdownDivider, DropdownItem, DropdownMenu, DropdownSection } from "@/components/dropdown";
										...
										<div className="w-32 shrink-0">
											<Link href={`/medibook/sessions/${params.sessionNumber}/committees/${committee.slug || committee.id}`} aria-hidden="true">
												<img
													...
													src={committee?.coverImage ? `/api/committees/${committee.id}/cover` : `/gradients/${((index + 1) % 6) + 1}.jpg`}
