...
export default function Messaging() {
	...
	return (
		<div className="grow h-full p-6 lg:rounded-lg lg:bg-white lg:p-0 lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
			<div className="w-full flex h-full shadow-md">
				<div className="h-full flex flex-col gap-2 p-4">
					...
					<div className="flex w-full gap-2 flex-1">
						...
						<Button color="white" className="h-9">
							+
						</Button>
					</div>
