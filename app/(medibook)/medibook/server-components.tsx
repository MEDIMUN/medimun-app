	...
	return (
		<>
			<TopBar
				...
				hideSearchBar>
				{authorizedToEditAnnouncement(authSession, selectedAnnouncement) && (
					<SearchParamsButton className="mr-2 md:-translate-y-5" searchParams={{ "edit-announcement": selectedAnnouncement.id }}>
						Edit Announcement
					</SearchParamsButton>
				)}
			</TopBar>
