...
export function UserChip({ uid, officialName, displayName }) {
	...
	return (
		<div
			...
			key={uid}
			className="flex cursor-pointer select-none justify-center gap-1 rounded-full bg-neutral-200 p-1 pl-1 pr-2 align-middle text-sm shadow-sm duration-200 hover:bg-primary hover:text-white hover:line-through">
