...
export default function Beta() {
	return (
		<div className="border-2 cursor-pointer flex flex-row border-red-500 bg-slate-50 text-[10px] text-left justify-center fixed bottom-0 right-0 rounded-[15px] h-[50px] p-1.5 w-[400px] z-[350] m-2.5 shadow-md opacity-[50%] hover:opacity-100">
			<div>
