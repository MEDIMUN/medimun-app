	...
	return (
		<footer class="relative z-[40] bg-black">
			<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
				<div class="flex flex-col items-center gap-4 rounded-lg bg-[var(--medired)] p-6 shadow-lg sm:flex-row sm:justify-between">
					<strong class="text-xl text-white sm:text-xl">Ready to join?</strong>

					<a
						class="inline-flex items-center gap-2 rounded-full border border-white bg-white px-8 py-3 text-[var(--medired)] hover:bg-transparent hover:text-white focus:outline-none focus:ring active:bg-white/90"
						href="/">
				...
				<div class="mt-16">
					<ul class="flex justify-center gap-6 sm:justify-end">
						<li>
							<a href="/" rel="noreferrer" target="_blank" class="text-white transition hover:text-[var(--medired)]">
