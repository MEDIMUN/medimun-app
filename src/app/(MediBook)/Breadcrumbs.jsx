		...
		<div className="max-h-[50px] flex fdr items-center w-[100%] my-1.5 pl-[20px]">
			<Link href="/medibook">
				<div className="flex fdr items-center justifi-middle">
					<Image alt="MediBook Logo" className="fill-black grayscale hover:filter-none hidden md:block" src={MediBookLogo} height={16} />
					<Image alt="MediBook Badge" className="min-w-[33px] grayscale hover:filter-none max-w-[35px] md:hidden" src={MediBookBadge} />
				</div>
			</Link>
			<Separator />
