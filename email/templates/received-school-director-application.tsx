...
export function ReceivedSchoolDirectorApplicationTemplate({
  applicationId,
  officialName,
  officialSurname,
  schoolName,
    ...
    <Row>
      <Column>
        <Text className="mt-0 text-[15px]">
          ...
          <br />
          <br />
          We will review your application and get back to you as soon as possible. You can check the status of your
          application at any time by visiting the applications page on MediBook where you have applied. You will also
          receive an email notification when your application has been reviewed.
          <br />
          <br />
