...
export function Text({ as: Component = "p", className, ...props }: TextProps) {
	return <Component data-slot="text" {...props} className={clsx(className, "text-base/6 text-zinc-500 dark:text-zinc-400 sm:text-sm/6")} />;
}
