...
const styles = {
	...
	colors: {
		...
		primary: [
			"text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:primary)] [--btn-border:var(--color-red-700)]/90",
			"[--btn-icon:var(--color-red-300)] data-active:[--btn-icon:var(--color-red-200)] data-hover:[--btn-icon:var(--color-red-200)]",
			"dark:bg-primary",
		],
		englishschool: [
			"text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:school])] [--btn-border:var(--color-red-700)]/90",
			"[--btn-icon:var(--color-red-300)] data-active:[--btn-icon:var(--color-red-200)] data-hover:[--btn-icon:var(--color-red-200)]",
