    ...
    <Headless.Listbox {...props} multiple={multiple}>
      <Headless.ListboxButton
        ...
        className={clsx([
          ...
          "focus:outline-none",
          // Focus ring
          "after:data-focus:ring-2 after:data-focus:ring-blue-500 after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent",
          // Disabled state
        ...
        return (
          <div
            className={clsx(
              ...
              // Focus
              "data-focus:bg-blue-500 data-focus:text-white outline-none",
              // Forced colors mode
