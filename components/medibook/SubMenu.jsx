							...
							return (
								<NavigationMenuItem key={item.href}>
									<Link href={item.href} legacyBehavior passHref>
										<NavigationMenuLink className={linkStyle + ` ${pathname == item.href && "bg-gradient-to-r from-gray-700 via-gray-900 to-black px-4 !text-white"}`}>
											{item.title}
										</NavigationMenuLink>
									</Link>
								</NavigationMenuItem>
