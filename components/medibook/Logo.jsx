...
export default function Logo({ color = "white", quality = 75 }) {
	switch (color) {
		case "red":
			return <Image quality={quality} src={RedLogo} alt="MEDIMUN Logo" fill />;
		case "black":
			return <Image quality={quality} src={BlackLogo} alt="MEDIMUN Logo" fill />;
		case "white":
			return <Image quality={quality} src={WhiteLogo} alt="MEDIMUN Logo" fill />;
	}
}
